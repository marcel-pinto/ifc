...
! Repita ate termos total_numeros distintos
   DO
...
! Multiplique-o por 49 para obter um numero aleatorio no intervalo
!                                                      [0.0, 49.0)
      xaleatorio = xaleatorio * 49.0
! Arredonde para baixo e some 1 para obter um numero inteiro entre 1 e
! 49
      proxima_escolha = floor(xaleatorio) + 1

! veja se eh  diferente dos numeros selecionados ate agora e se for
! adicione-o a lista
      diferente = .true.
